...
#define BACNET_INSTANCE_NO	    100 // device number given to me
...
// printing the data on tab reg	
	...
	printf("modbus data 0 %d\n",tabreg[0]);
	printf("modbus data 1 %d\n",tabreg[1]);
